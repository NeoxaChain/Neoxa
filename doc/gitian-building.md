...
- [Building Neoxa Core](#building-neoxa-core)
...
git clone https://github.com/The-Neoxa-Endeavor/neoxa
...
```bash
    ...
    From https://github.com/The-Neoxa-Endeavor/neoxa
...
SIGPATH=/some/root/path/neoxa-detached-sigs
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/neoxa-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/neoxa-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/neoxa-osx-build.assert
```
