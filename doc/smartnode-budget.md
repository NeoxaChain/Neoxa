...
Format: ```mngovernance prepare proposal-name url payment-count block-start neoxa-address monthly-payment-neoxa```
...
Format: ```mngovernance submit proposal-name url payment-count block-start neoxa-address monthly-payment-neoxa fee-tx```
