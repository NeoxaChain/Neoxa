...
The following new options are available for neoxad and neoxa-qt:
...
The following rpc commands are available:
 ...
 - _keepass init_: sets up the association between neoxad and keepass by generating an AES key and sending an association message to KeePassHttp. This will trigger KeePass to ask for an Id for the association. Returns the association and the base64 encoded string for the AES key.
...
Sample initialization flow from _neoxa-qt_ console (this needs to be done only once to set up the association):

 - Have KeePass running with an open database
 - Start _neoxa-qt_
 - Open console
 - Type "_keepass init_" in neoxa-qt console
