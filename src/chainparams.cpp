...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 999999999999ULL;
   ...
   //   FindMainNetGenesisBlock(1652138420, 0x20001fff, "main");
        ...
        vSporkAddresses = {"GTbBCJzqRWyFBMrap2fY39eZaXnLnojJ3F"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
     ...
     //   consensus.DIP0003EnforcementHeight = 7300;
        ...
        //consensus.vDeployments[Consensus::DEPLOYMENT_COINBASE_ASSETS].nOverrideMinerConfirmationWindow = 2016;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].bit = 3;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1685243490;
