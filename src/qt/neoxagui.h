...
#ifndef NEOXA_QT_NeoxaGUI_H
#define NEOXA_QT_NeoxaGUI_H
...
/**
  neoxa GUI main class. This class represents the main window of the neoxa UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NeoxaGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NeoxaGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~NeoxaGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a neoxa wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
