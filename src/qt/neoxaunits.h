...
#ifndef NEOXA_QT_NEOXAUNITS_H
#define NEOXA_QT_NEOXAUNITS_H
...
*/
class NeoxaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NeoxaUnits(QObject *parent);
...
typedef NeoxaUnits::Unit NeoxaUnit;

#endif // NEOXA_QT_NEOXAUNITS_H
