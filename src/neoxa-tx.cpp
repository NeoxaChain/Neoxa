...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s neoxa-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  neoxa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded neoxa transaction") + "\n" +
              "  neoxa-tx [options] -create [commands]   " + _("Create hex-encoded neoxa transaction") + "\n" +
              "\n";
