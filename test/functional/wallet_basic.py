...
class WalletTest(NeoxaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 NEOX from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 NEOX with subtract fee from amount
        ...
        # Sendmany 10 NEOX with subtract fee from amount
