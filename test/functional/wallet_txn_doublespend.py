...
class TxnMallTest(NeoxaTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 NEOX:
        ...
        # First: use raw transaction API to send 1240 NEOX to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 NEOX coin each
        ...
        # Node0's balance should be starting balance, plus 50NEOX for another
        ...
        # Node0's total balance should be starting balance, plus 100NEOX for 
