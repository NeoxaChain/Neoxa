...
"""Verify that starting neoxad with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start neoxad with -h for help text")
        ...
        self.log.info("Start neoxad with -version for version information")
