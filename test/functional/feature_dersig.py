...
class BIP66Test(NeoxaTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # neoxad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and neoxad produces more specific reject
            # reasons.
