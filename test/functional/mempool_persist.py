...
By default, neoxad will dump mempool on shutdown and
...
class MempoolPersistTest(NeoxaTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give neoxad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent neoxad from writing mempool.dat to disk. Verify that `savemempool` fails")
