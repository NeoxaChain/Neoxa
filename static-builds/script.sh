...
find ${DISTNAME}/bin -type f -executable -exec ../neoxacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../neoxacoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/neoxacoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/neoxacoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
